...
ConversionRegistry.register(RGB, RGB255, (rgb) => {
  return new RGB255(rgb.r * 255, rgb.g * 255, rgb.b * 255);
});

ConversionRegistry.register(RGB, CMY, (rgb) => {
 ...
 *
 */
ConversionRegistry.register(RGB, CMYK, (rgb) => {
...
ConversionRegistry.register(RGB, HSI, (rgb) => {
...
ConversionRegistry.register(RGB, HSL, (rgb) => {
...
ConversionRegistry.register(RGB, HSV, (rgb) => {
...
ConversionRegistry.register(RGB, HWB, (rgb) => {
  const { hue, chroma, min, max } = HueHelper.rgbToChroma(rgb);
...
ConversionRegistry.register(RGB, XYZ, (rgb) => {
