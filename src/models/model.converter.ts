import { HSI, RGB, RGB255 } from ".";
import { ConversionRegistry } from "../conversion";

// TODO: split into multiple files?
export default function (instance: ConversionRegistry) {
  // RGB255
  instance.register(RGB255, RGB, (rgb) => rgb.to.RGB());

  // RGB
  instance.register(RGB, RGB255, (rgb) => rgb.to.RGB255());
  instance.register(RGB, HSI, (rgb) => rgb.to.HSI());

  // HSI
  instance.register(HSI, RGB, (hsi) => hsi.to.RGB());
}
