import { CMY } from "..";
import { RGB } from "../..";
import { CMYK } from "./cmyk.model";

export class CMYKConversion {
  constructor(private cmyk: CMYK) {}
  ...
  public RGB(): RGB {
    return new RGB(
      (1 - this.cmyk.c) * (1 - this.cmyk.k),
      (1 - this.cmyk.m) * (1 - this.cmyk.k),
      (1 - this.cmyk.y) * (1 - this.cmyk.k),
      this.cmyk.a
    );
  }

  public CMY(): CMY {
    return new CMY(this.cmyk.c + this.cmyk.k, this.cmyk.m + this.cmyk.k, this.cmyk.y + this.cmyk.k, this.cmyk.a);
  }
}
